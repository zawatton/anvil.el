...
- Phase 1 (Future API + batch REPL): ~SHIPPED~ (2026-04-17)
  ...
  - tests/anvil-offload-test.el: 8/8 pass (basic math / utf-8 /
    error prop / concurrent / cancel / await timeout / REPL death /
    respawn after stop)
- Phase 2–5: ~DRAFT~ — レビュー前。Doc 01 (worker pool v2) の batch
  pool を前提とする。
