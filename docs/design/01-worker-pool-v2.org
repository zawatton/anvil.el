...
* STATUS
~Phase 1+2 SHIPPED 2026-04-16~ — lane split + ~:kind~ keyword + regex/intent
classifier + ~--metrics-classify~ ヒストグラム + 29 ERT。batch warmup
(Phase 3) / connection reuse (Phase 4) / metrics UI (Phase 5) は未着手。
