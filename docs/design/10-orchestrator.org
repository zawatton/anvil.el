...
* STATUS
  ...
  :END:
~Phase 1a + 1b + 2 + 2b + 3 + 3b + 4 + 4b + 5 + 6C MVP + 6C' + 6C'' + gemma4-strip + observability + glue-helpers SHIPPED (develop branch)~ (2026-04-19)
...
*** Phase 7a — ~orchestrator-submit-and-collect~ sync API (所要 2-4h)
