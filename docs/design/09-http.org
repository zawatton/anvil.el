...
#+date: 2026-04-18
#+author: zawatton
#+property: status PHASE-1A-1B-SHIPPED
...
Phase 1c-1e (body-overflow to disk, header-filter minimal, batch
fetch, robots.txt) は次スロット。Review Questions Q1-Q10 resolved
のままキープ。
