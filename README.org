...
Rust runtime called NeLisp) as 200+ tools an AI agent can call.
...
| Repo | Role | Required? |
|------+------+-----------|
| [[https://github.com/zawatton/anvil.el][anvil.el]]      | The AI brain — MCP server + 200+ tools | yes |
